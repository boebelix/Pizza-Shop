                  ...
                  child: Opacity(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          Order order =
                              new Order(pizzas: context.read<Cart>().pizzas);
                          ShopEndpoint.instance()
                              .sendOrder(order)
                              .then((response) {
                            ...
                            Scaffold.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text("Ihre Bestellung wurde aufgegeben."),
                              ),
                            );
                          }).catchError((error) {
                            Scaffold.of(context).showSnackBar(
                              SnackBar(
                                  content: Text(
                                      "Ihre Bestellung konnte nicht verarbeitet werden: ${error.message}")),
                            );
                          });
                        });
                      },
